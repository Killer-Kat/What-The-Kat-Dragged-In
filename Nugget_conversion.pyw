...
#Version 3.5, Made by Killer-Kat
...
label_1 = Label(root, text="Input Amount of Nuggets:", bg="Darkorange2", fg="gold")
...
label_2 = Label(root, textvariable=labelText, bg="Darkorange2", fg="gold")
label_2.grid(row=2, columnspan=2,)

button_1 = Button(root, text="Convert Gold to Chicken", command=Gold2Chicken, bg="Darkorange2", fg="gold")
button_1.grid(row=1)
button_2 = Button(root, text="Convert Chicken to Gold", command=Chicken2Gold, bg="Darkorange2", fg="gold")
button_2.grid(row=1, column=1)

output = Text(root, width=35, height=2, wrap=WORD, bg="Darkorange2", fg="gold")
