...
public:
    ...
    void main()
    {
        ...
        switch (PlayerChoice) {
        case 0:
            std::cout << "You Chose Rock and " << CPUPlayer.CPUChoiceMessage << "\n";
            if (CPUPlayer.CPUChoice == 0) {
                std::cout << "The game ends in a tie!\n";
            }
            else if (CPUPlayer.CPUChoice == 2) {
                std::cout << "You win!\n";
            }
            else {
                std::cout << "CPU wins!\n";
            ...
            break;
        case 1:
            std::cout << "You Chose Paper and " << CPUPlayer.CPUChoiceMessage << "\n";
            if (CPUPlayer.CPUChoice == 1) {
                std::cout << "The game ends in a tie!\n";
            }
            else if (CPUPlayer.CPUChoice == 0) {
                std::cout << "You win!\n";
            }
            else {
                std::cout << "CPU wins!\n";
            ...
            break;
        case 2:
            std::cout << "You Chose Scissors and " << CPUPlayer.CPUChoiceMessage << "\n";
            if (CPUPlayer.CPUChoice == 2) {
                std::cout << "The game ends in a tie!\n";
            }
            else if (CPUPlayer.CPUChoice == 1) {
                std::cout << "You win!\n";
            }
            else {
                std::cout << "CPU wins!\n";
